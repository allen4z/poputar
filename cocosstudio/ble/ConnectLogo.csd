<GameProjectFile>
  <PropertyGroup Type="Node" Name="ConnectLogo" ID="4a3fc2db-1bee-4729-a529-ebd5fe8b5dc5" Version="2.2.6.0" />
  <Content ctype="GameProjectContent">
    <Content>
      <Animation Duration="35" Speed="1.0000">
        <Timeline ActionTag="-1490967379" Property="FileData">
          <TextureFrame FrameIndex="4" Tween="False">
            <TextureFile Type="PlistSubImage" Path="ble/ble_loading_1.png" Plist="ble/BLEScene/BlePlist.plist" />
          </TextureFrame>
        </Timeline>
        <Timeline ActionTag="-967797217" Property="Position">
        ...
        <Timeline ActionTag="-967797217" Property="Scale">
        ...
        <Timeline ActionTag="-967797217" Property="RotationSkew">
        ...
        <Timeline ActionTag="-967797217" Property="Alpha">
          ...
          <IntFrame FrameIndex="15" Value="64">
            <EasingData Type="0" />
          </IntFrame>
          <IntFrame FrameIndex="20" Value="0">
            <EasingData Type="0" />
          </IntFrame>
          <IntFrame FrameIndex="25" Value="64">
            <EasingData Type="0" />
          </IntFrame>
          <IntFrame FrameIndex="30" Value="127">
            <EasingData Type="0" />
          </IntFrame>
          <IntFrame FrameIndex="35" Value="191">
            <EasingData Type="0" />
          </IntFrame>
        </Timeline>
        <Timeline ActionTag="-967797217" Property="FileData">
          <TextureFrame FrameIndex="4" Tween="False">
            <TextureFile Type="PlistSubImage" Path="ble/ble_loading_2.png" Plist="ble/BLEScene/BlePlist.plist" />
          </TextureFrame>
        </Timeline>
      </Animation>
      <ObjectData Name="Node" Tag="2287" ctype="GameNodeObjectData">
        <Size />
        <Children>
          <AbstractNodeData Name="ble_ble_loading_1_1" ActionTag="-1490967379" Tag="2288" IconVisible="False" LeftMargin="-74.5000" RightMargin="-73.5000" TopMargin="-142.5000" BottomMargin="-140.5000" ctype="SpriteObjectData">
